...
path <- "output/COI/pseudo"
if(!dir.exists(path)) dir.create(path)

path_gc2 <- "output/COI/pseudo/gc2"
if(!dir.exists(path_gc2)) dir.create(path_gc2)

path_gc4 <- "output/COI/pseudo/gc4"
if(!dir.exists(path_gc4)) dir.create(path_gc4)

path_gc5 <- "output/COI/pseudo/gc5"
if(!dir.exists(path_gc5)) dir.create(path_gc5)

path_gc9 <- "output/COI/pseudo/gc9"
if(!dir.exists(path_gc9)) dir.create(path_gc9)

path_gc13 <- "output/COI/pseudo/gc13"
...
nochim_nosingle <- "output/COI/COI_nochim_nosingle_ASVs.fa"

# "the final, non-chimeric , non-singleton sequences with short >ASV... type headers"

fastafile <- read.fasta("output/COI/COI_nochim_nosingle_ASVs.fa",
